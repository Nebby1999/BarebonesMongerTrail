...
public class MongerManager_OOP : MonoBehaviour
{
    static readonly ProfilerMarker _trailUpdateMarker = new ProfilerMarker(ProfilerCategory.Scripts, "MongerTrail_OOP.TrailUpdates");
    static readonly ProfilerMarker _physicsChecksMarker = new ProfilerMarker(ProfilerCategory.Scripts, "MongerTrail_OOP.PhysicsChecks");
    static readonly ProfilerMarker _lifetimeAndScalingMarker = new ProfilerMarker(ProfilerCategory.Scripts, "MongerTrail_OOP.LifetimeAndScalings");
    ...
    public MongerTrail_OOP mongerPrefab;
    ...
    private List<MongerTrail_OOP> _mongerInstances = new List<MongerTrail_OOP>();
